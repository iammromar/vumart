                  ...
                  $.ajax({
                      ...
                      for (let i = 0; i < data["products"].length; i++) {
                        $("#cart_inside").prepend(`<li class="dropcart__item">
                                 <div class="dropcart__item-image image image--type--product"><a class="image__body" href="#"><img style="    width: 80px;" class="image__tag" src="${data["products"][i]["image"]||""}" alt=""></a></div>
                                 <div class="dropcart__item-info" style="width: 56%;">
                                    ...
                                    <div class="dropcart__item-meta">
                                       <div class="dropcart__item-quantity" style=" color: black; font-weight: 700; ">${data["products"][i]["qty"]||""}</div>
...
console.log("hehe");
 ...
 $.ajax({
                      ...
                      success: function(data){
                        ...
                        $("#cart_summary").trigger('reset');
                        $("#cart_summary").empty();
                           $("#cart_summary").prepend(`₼ ${data["summary"]||"0"}`);
                      ...
                      for (let i = 0; i < data["products"].length; i++) {
                        $("#cart_inside").prepend(`<li class="dropcart__item">
                                 <div class="dropcart__item-image image image--type--product"><a class="image__body" href="#"><img class="image__tag" width="80px;" src="${data["products"][i]["image"]||""}" alt=""></a></div>
                                 <div class="dropcart__item-info" style="width: 56%;">
                                    <div class="dropcart__item-name"><a href="#">${data["products"][i]["name"]||""}</a></div>
                                    <ul class="dropcart__item-features">
                                      <li>${data["products"][i]["cat"]||""}</li>
