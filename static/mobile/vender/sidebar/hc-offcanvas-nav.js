...
!function(J, n) {
    ...
    J.fn.extend({
        hcOffcanvasNav: function() {
            ...
            var U = this
              , $ = J(R.body);
            void 0 !== n.maxWidth && (e("maxWidth", "disableAt", "option"),
            n.disableAt = n.maxWidth);
            var z = J.extend({}, {
                width: 280,
                height: "auto",
                disableAt: !1,
            ...
            return this.each(function() {
                ...
                if (e.find("ul").addBack("ul").length) {
                    var n, o, i, c, t, a, s, l, y = "hc-nav-".concat(++dn), r = (n = "hc-offcanvas-".concat(dn, "-style"),
                    ...
                    ,
                    {
                        ...
                        remove: function(n, e) {
                            n = n.trim(),
                            e ? (e = e.trim(),
                            void 0 !== c[e][n] && delete c[e][n]) : void 0 !== i[n] && delete i[n]
                        },
                        insert: function() {
                            var n = "";
                            for (var e in c) {
                    ...
                    z.customToggle ? f = J(z.customToggle).addClass("hc-nav-trigger ".concat(y)).on("click", _) : (f = J('<a href="#" aria-label="Open Menu" class="hc-nav-trigger '.concat(y, '"><span></span></a>')).on("click", _),
                    e.after(f));
                    var A = function(n, e, a) {
                        if ("number" == typeof e && ("number" == typeof n || B.length)) {
                            ...
                            if (o.length) {
                                var i = o.first()
                                  , c = o.last();
                                "number" == typeof n ? o.eq(n).focus() : (B[B.length - 1].focus(),
                                B.pop()),
                                Z.off(d),
                                Z.on(d, function(n) {
                                    ("Tab" === n.key || 9 === n.keyCode) && (n.shiftKey ? R.activeElement === i[0] && (n.preventDefault(),
                                    c.focus()) : R.activeElement === c[0] && (n.preventDefault(),
                                    i.focus()))
                                })
                            }
                        }
                      ...
                      , E = function() {
                        ...
                        z.pushContent && u && a && r.add(function n(e) {
                        ...
                        }(z.pushContent), "transition: ".concat(a, " ").concat(s, "ms ").concat(l)),
                        r.insert()
                    }
                      , P = function(n) {
                        var e = f.css("display")
                        ...
                        p.off("click").attr("class", "").attr("aria-hidden", !0).attr("aria-labelledby", y).addClass(c),
                      ...
                      , M = function() {
                        ...
                        h = function l(n, e) {
                            ...
                            return n.each(function() {
                                ...
                                void 0 !== n.attr("data-nav-active") && (b = e,
                                n.removeAttr("data-nav-active")),
                                n.children("li").each(function() {
                                    var n = J(this)
                                      ...
                                      , i = null;
                                    o.length && (n.data("hc-uniqid") ? i = n.data("hc-uniqid") : (i = Math.random().toString(36).substr(2),
                                    n.data("hc-uniqid", i))),
                                    c.items.push({
                                        id: i,
                                        classes: n.attr("class") || null,
                            ...
                            J.each(n, function(n, e) {
                                ...
                                J.each(e.items, function(n, e) {
                                    ...
                                    if (e.custom) {
                                        ...
                                        if (i.wrap('<div class="nav-item-wrapper">'),
                                        ...
                                        if (e.subnav.length) {
                                            ...
                                            q()) {
                                                ...
                                                i.attr("href") && "#" !== i.attr("href") ? p(J('<a href="#" class="nav-next" aria-label="'.concat(d, ' Submenu" role="menuitem" tabindex="0">')).on("click", on).insertAfter(i)) : (J('<span class="nav-next">').appendTo(i),
                                                p(i))
                                            } else
                                                i.attr("aria-expanded", !0);
                                            w[r]++,
                                            h(e.subnav, c, r, d, w[r] - 1, g)
                                        }
                                    }
                                })
                            }),
                    ...
                    var H = function(n, e, a) {
                        ...
                        if (t.length) {
                            ...
                            a && "overlap" === z.levelOpen && (c.off("click").on("click", on),
                ...
                function L(n, e) {
                    if ((!I() || void 0 !== e) && (function() {
                        ...
                        z.disableBody && (x = X.scrollTop() || Y.scrollTop() || $.scrollTop(),
                        R.documentElement.scrollHeight > R.documentElement.clientHeight && Y.addClass("hc-nav-yscroll"),
                    ...
                    q())) {
                        ...
                        if ("number" == typeof n && "number" == typeof e) {
                            if (!(a = J("#".concat(y, "-").concat(n, "-").concat(e))).length)
                                return void console.warn("HC Offcanvas Nav: level ".concat(n, " doesn't have index ").concat(e))
                        } else
                            b ? (a = v.find(".hc-chk").filter("[value=".concat(b, "]")),
                            b = null) : !1 === z.closeOpenLevels && (a = v.find(".hc-chk").filter(":checked").last());
                        if (a && a.length) {
                            var t = [];
                            n = a.data("level"),
                            e = a.data("index"),
                            1 < n && (a.parents(".nav-wrapper").each(function() {
                                var n = J(this)
                                  , e = n.data("level");
                                0 < e && t.push({
                                    level: e,
                ...
                function W() {
                    if (I()) {
                        ...
                        "expand" === z.levelOpen && -1 !== ["top", "bottom"].indexOf(z.position) ? Q(0) : q() && (O = setTimeout(function() {
                            Q(0)
                        }, "expand" === z.levelOpen ? s : 0)),
                        z.disableBody && ($.removeClass("hc-nav-open"),
                        Y.removeClass("hc-nav-yscroll"),
                        x)) {
                            if ($.css("top", "").scrollTop(x),
                            Y.scrollTop(x),
                            "bottom" === z.position) {
                                var n = x;
                                setTimeout(function() {
                ...
                function F(n, e) {
                    ...
                    "overlap" === z.levelOpen && (c.on("click", function() {
                        return Q(n, e)
                    }),
